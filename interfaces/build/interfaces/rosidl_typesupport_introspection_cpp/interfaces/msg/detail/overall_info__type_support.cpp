...
{
  new (message_memory) interfaces::msg::OverallInfo(_init);
}

void OverallInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::msg::OverallInfo *>(message_memory);
  typed_message->~OverallInfo();
}

size_t size_function__OverallInfo__road_info(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<interfaces::msg::RoadInfo> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<interfaces::msg::RoadInfo> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<interfaces::msg::RoadInfo> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const interfaces::msg::RoadInfo *>(
    get_const_function__OverallInfo__road_info(untyped_member, index));
  auto & value = *reinterpret_cast<interfaces::msg::RoadInfo *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<interfaces::msg::RoadInfo *>(
    get_function__OverallInfo__road_info(untyped_member, index));
  const auto & value = *reinterpret_cast<const interfaces::msg::RoadInfo *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OverallInfo_message_member_array[5] = {
  {
    ...
    offsetof(interfaces::msg::OverallInfo, number_of_cities),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::OverallInfo, number_of_roads),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<interfaces::msg::RoadInfo>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::OverallInfo, road_info),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::OverallInfo, src_city),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::msg::OverallInfo, des_city),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OverallInfo_message_members = {
  ...
  5,  // number of fields
  sizeof(interfaces::msg::OverallInfo),
...
{
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::OverallInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, msg, OverallInfo)() {
  return &::interfaces::msg::rosidl_typesupport_introspection_cpp::OverallInfo_message_type_support_handle;
}
