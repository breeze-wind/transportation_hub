...
bool interfaces__msg__road_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._road_info.RoadInfo", full_classname_dest, 34) == 0);
  }
  interfaces__msg__RoadInfo * ros_message = _ros_message;
  {  // source
...
PyObject * interfaces__msg__road_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._road_info");
