...
#include "interfaces/msg/detail/road_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::RoadInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::RoadInfo & ros_message)
{
  // Member: source
  cdr >> ros_message.source;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::RoadInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::RoadInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::RoadInfo *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_RoadInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, RoadInfo)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_RoadInfo__handle;
}
