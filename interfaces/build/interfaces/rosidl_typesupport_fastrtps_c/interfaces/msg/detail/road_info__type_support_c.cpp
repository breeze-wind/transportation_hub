...
#include "interfaces/msg/detail/road_info__rosidl_typesupport_fastrtps_c.h"
...
using _RoadInfo__ros_msg_type = interfaces__msg__RoadInfo;
...
static uint32_t _RoadInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__RoadInfo(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__RoadInfo;
    is_plain =
      (
...
static size_t _RoadInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__RoadInfo(
