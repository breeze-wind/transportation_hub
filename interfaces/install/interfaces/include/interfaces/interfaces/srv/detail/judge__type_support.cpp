...
{
  new (message_memory) interfaces::srv::Judge_Request(_init);
}

void Judge_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::Judge_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Judge_Request_message_member_array[1] = {
  {
    ...
    offsetof(interfaces::srv::Judge_Request, path),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Judge_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::Judge_Request),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Judge_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Judge_Request)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Judge_Request_message_type_support_handle;
}
...
void Judge_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) interfaces::srv::Judge_Response(_init);
}

void Judge_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces::srv::Judge_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Judge_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces::srv::Judge_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Judge_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces::srv::Judge_Response),
...
{
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Judge_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Judge_Response)() {
  return &::interfaces::srv::rosidl_typesupport_introspection_cpp::Judge_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Judge_service_members = {
  ...
  // see get_service_type_support_handle<interfaces::srv::Judge>()
...
get_service_type_support_handle<interfaces::srv::Judge>()
{
  ...
  auto service_type_support =
    &::interfaces::srv::rosidl_typesupport_introspection_cpp::Judge_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, Judge)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<interfaces::srv::Judge>();
}
