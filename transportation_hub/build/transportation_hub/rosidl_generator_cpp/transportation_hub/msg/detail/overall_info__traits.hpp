...
#ifndef TRANSPORTATION_HUB__MSG__DETAIL__OVERALL_INFO__TRAITS_HPP_
#define TRANSPORTATION_HUB__MSG__DETAIL__OVERALL_INFO__TRAITS_HPP_
...
// Member 'road_info'
#include "transportation_hub/msg/detail/road_info__traits.hpp"
...
inline void to_yaml(
  const transportation_hub::msg::OverallInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const transportation_hub::msg::OverallInfo & msg)
{
  return transportation_hub::msg::to_yaml(msg);
}

template<>
inline const char * data_type<transportation_hub::msg::OverallInfo>()
{
  return "transportation_hub::msg::OverallInfo";
}

template<>
inline const char * name<transportation_hub::msg::OverallInfo>()
{
  return "transportation_hub/msg/OverallInfo";
}

template<>
struct has_fixed_size<transportation_hub::msg::OverallInfo>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<transportation_hub::msg::OverallInfo>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<transportation_hub::msg::OverallInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // TRANSPORTATION_HUB__MSG__DETAIL__OVERALL_INFO__TRAITS_HPP_
