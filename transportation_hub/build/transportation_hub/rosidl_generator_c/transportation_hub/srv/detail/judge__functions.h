...
#ifndef TRANSPORTATION_HUB__SRV__DETAIL__JUDGE__FUNCTIONS_H_
#define TRANSPORTATION_HUB__SRV__DETAIL__JUDGE__FUNCTIONS_H_
 ...
 * calls
 * transportation_hub__srv__Judge_Request__init().
...
/**
 * It calls
 * transportation_hub__srv__Judge_Request__fini()
 ...
 * transportation_hub__srv__Judge_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * transportation_hub__srv__Judge_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * transportation_hub__srv__Judge_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_transportation_hub
...
/**
 * It calls
 * transportation_hub__srv__Judge_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_transportation_hub
...
/**
 * It allocates the memory for the array and calls
 * transportation_hub__srv__Judge_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_transportation_hub
...
/**
 * It calls
 * transportation_hub__srv__Judge_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TRANSPORTATION_HUB__SRV__DETAIL__JUDGE__FUNCTIONS_H_
