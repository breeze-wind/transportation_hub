...
transportation_hub__msg__RoadInfo__create()
{
  ...
  transportation_hub__msg__RoadInfo * msg = (transportation_hub__msg__RoadInfo *)allocator.allocate(sizeof(transportation_hub__msg__RoadInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(transportation_hub__msg__RoadInfo));
  bool success = transportation_hub__msg__RoadInfo__init(msg);
  if (!success) {
...
transportation_hub__msg__RoadInfo__destroy(transportation_hub__msg__RoadInfo * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    transportation_hub__msg__RoadInfo__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
transportation_hub__msg__RoadInfo__Sequence__init(transportation_hub__msg__RoadInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  transportation_hub__msg__RoadInfo * data = NULL;

  if (size) {
    data = (transportation_hub__msg__RoadInfo *)allocator.zero_allocate(size, sizeof(transportation_hub__msg__RoadInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = transportation_hub__msg__RoadInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        transportation_hub__msg__RoadInfo__fini(&data[i - 1]);
      }
...
transportation_hub__msg__RoadInfo__Sequence__fini(transportation_hub__msg__RoadInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      transportation_hub__msg__RoadInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  transportation_hub__msg__RoadInfo__Sequence * array = (transportation_hub__msg__RoadInfo__Sequence *)allocator.allocate(sizeof(transportation_hub__msg__RoadInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = transportation_hub__msg__RoadInfo__Sequence__init(array, size);
  if (!success) {
...
transportation_hub__msg__RoadInfo__Sequence__destroy(transportation_hub__msg__RoadInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    transportation_hub__msg__RoadInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
transportation_hub__msg__RoadInfo__Sequence__are_equal(const transportation_hub__msg__RoadInfo__Sequence * lhs, const transportation_hub__msg__RoadInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!transportation_hub__msg__RoadInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  transportation_hub__msg__RoadInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(transportation_hub__msg__RoadInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    transportation_hub__msg__RoadInfo * data =
      (transportation_hub__msg__RoadInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!transportation_hub__msg__RoadInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          transportation_hub__msg__RoadInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!transportation_hub__msg__RoadInfo__copy(
